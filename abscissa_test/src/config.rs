...
/// Abscissa Test Configuration
#[derive(Clone, Config, Debug, Deserialize, Serialize)]
#[serde(deny_unknown_fields)]
pub struct AbscissaTestConfig {
...
/// use `#[derive(Default)]` on AbscissaTestConfig instead.
impl Default for AbscissaTestConfig {
    fn default() -> Self {
        Self {
